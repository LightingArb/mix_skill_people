...
### 和其他 skill 的潛在關聯
- autoplan（gstack） - 互補 - 共享領域：meta；共享分類：流程型、元技能型；共同關鍵詞：instructions, make, what
- cso（gstack） - 互補 - 共同關鍵詞：instructions, make, top, what
- plan-design-review（gstack） - 互補 - 共享分類：流程型；共同關鍵詞：make, philosophy, what, works
- setup-deploy（gstack） - 互補 - 共享分類：流程型；共同關鍵詞：instructions, make, set, what

...
### 和其他 skill 的潛在關聯
- writing-skills（superpowers） - 相似 - 共享領域：testing；共享分類：思考框架型、流程型；共同關鍵詞：bottom, common, creating, flags
- ship（gstack） - 相似 - 共享領域：review, shipping, testing；共享分類：審查型、流程型；共同關鍵詞：about, gate, key, verification
- test-driven-development（superpowers） - 相似 - 共享領域：testing；共享分類：思考框架型、流程型；共同關鍵詞：common, flags, iron, law
- review（gstack） - 相似 - 共享領域：review, shipping, testing；共享分類：思考框架型、審查型、流程型；共同關鍵詞：about

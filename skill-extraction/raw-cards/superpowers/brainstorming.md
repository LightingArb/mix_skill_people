...
- office-hours（gstack） - 相似 - 共享領域：design, planning；共享分類：思考框架型；共同關鍵詞：brainstorming, building, visual
- design-consultation（gstack） - 相似 - 共享領域：design, planning；共享分類：思考框架型、流程型；共同關鍵詞：building
- design-shotgun（gstack） - 相似 - 共享領域：design, planning；共享分類：思考框架型、流程型；共同關鍵詞：visual

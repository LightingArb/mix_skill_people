...
### 和其他 skill 的潛在關聯
- ship（gstack） - 互補 - 共享分類：工具程序型、流程型；共同關鍵詞：building, changelog, commit, deploying
- qa-only（gstack） - 互補 - 共享分類：流程型；共同關鍵詞：browse, building, don, never
- qa（gstack） - 互補 - 共享分類：工具程序型、流程型；共同關鍵詞：browse, building, protocol, search
- codex（gstack） - 互補 - 共享領域：meta；共享分類：工具程序型、流程型；共同關鍵詞：building, codex, openai, protocol

...
### 和其他 skill 的潛在關聯
- guard（gstack） - 相似 - 共享領域：safety；共享分類：工具程序型；共同關鍵詞：asked, careful, destructive, drop
- freeze（gstack） - 相似 - 共享領域：safety；共享分類：工具程序型；共同關鍵詞：asked, works
- cso（gstack） - 相似 - 共享領域：safety；共同關鍵詞：what
- plan-design-review（gstack） - 互補 - 共同關鍵詞：asked, live, what, works

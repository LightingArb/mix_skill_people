...
### 和其他 skill 的潛在關聯
- guard（gstack） - 相似 - 共享領域：safety；共享分類：工具程序型；共同關鍵詞：asked, blocks, directory, down
- unfreeze（gstack） - 相似 - 共享領域：safety；共享分類：工具程序型；共同關鍵詞：asked, edit, edits, freeze
- plan-design-review（gstack） - 互補 - 共同關鍵詞：asked, file, outside, scope
- autoplan（gstack） - 互補 - 共同關鍵詞：asked, file, one, scope

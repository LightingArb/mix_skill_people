...
### 和其他 skill 的潛在關聯
- ship（gstack） - 相似 - 共享領域：review, shipping, testing；共享分類：審查型、流程型；共同關鍵詞：about, adversarial, asked, askuserquestion
- plan-eng-review（gstack） - 相似 - 共享領域：review, testing；共享分類：思考框架型、審查型、流程型；共同關鍵詞：about, asked, askuserquestion, boil
- land-and-deploy（gstack） - 相似 - 共享領域：review, shipping；共享分類：審查型、流程型；共同關鍵詞：askuserquestion, base, boil, branch
- qa（gstack） - 相似 - 共享領域：review, testing；共享分類：審查型、流程型；共同關鍵詞：asked, askuserquestion, base, boil

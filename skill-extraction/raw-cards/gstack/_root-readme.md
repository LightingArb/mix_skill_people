...
### 和其他 skill 的潛在關聯
- land-and-deploy（gstack） - 相似 - 共享領域：shipping；共享分類：工具程序型、流程型；共同關鍵詞：gstack, like, see, telemetry
- document-release（gstack） - 相似 - 共享領域：meta, shipping；共享分類：工具程序型、流程型；共同關鍵詞：docs, gstack, telemetry
- plan-ceo-review（gstack） - 互補 - 共享分類：流程型；共同關鍵詞：docs, gstack, like, quick
- ship（gstack） - 相似 - 共享領域：shipping；共享分類：工具程序型、流程型；共同關鍵詞：gstack, see, telemetry

...
### 和其他 skill 的潛在關聯
- plan-design-review（gstack） - 相似 - 共享領域：planning, review；共享分類：審查型、流程型；共同關鍵詞：asked, askuserquestion, audit, base
- plan-ceo-review（gstack） - 相似 - 共享領域：planning, review；共享分類：審查型、流程型；共同關鍵詞：asked, askuserquestion, audit, base
- plan-eng-review（gstack） - 相似 - 共享領域：planning, review；共享分類：審查型、流程型；共同關鍵詞：asked, askuserquestion, boil, building
- ship（gstack） - 相似 - 共享領域：review；共享分類：審查型、流程型；共同關鍵詞：asked, askuserquestion, audit, auto-decide

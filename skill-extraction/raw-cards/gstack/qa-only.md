...
### 和其他 skill 的潛在關聯
- qa（gstack） - 相似 - 共享領域：browser, debugging, review；共享分類：審查型、流程型；共同關鍵詞：additional, application, asked, askuserquestion
- design-review（gstack） - 相似 - 共享領域：review；共享分類：審查型、流程型；共同關鍵詞：additional, asked, askuserquestion, boil
- land-and-deploy（gstack） - 相似 - 共享領域：browser, review；共享分類：審查型、流程型；共同關鍵詞：askuserquestion, boil, browse, building
- office-hours（gstack） - 互補 - 共同關鍵詞：asked, askuserquestion, boil, browse

...
### 和其他 skill 的潛在關聯
- careful（gstack） - 相似 - 共享領域：safety；共享分類：工具程序型；共同關鍵詞：asked, careful, destructive, drop
- freeze（gstack） - 相似 - 共享領域：safety；共享分類：工具程序型；共同關鍵詞：asked, blocks, directory, down
- design-review（gstack） - 互補 - 共享分類：流程型；共同關鍵詞：asked, command, live, outside
- plan-design-review（gstack） - 互補 - 共享分類：流程型；共同關鍵詞：asked, command, live, outside

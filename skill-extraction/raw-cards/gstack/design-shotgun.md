...
### 和其他 skill 的潛在關聯
- office-hours（gstack） - 相似 - 共享領域：design, planning；共享分類：思考框架型；共同關鍵詞：askuserquestion, boil, brainstorm, command
- plan-design-review（gstack） - 相似 - 共享領域：design, planning；共享分類：思考框架型、流程型；共同關鍵詞：askuserquestion, boil, command, completeness
- design-consultation（gstack） - 相似 - 共享領域：design, planning；共享分類：思考框架型、流程型；共同關鍵詞：askuserquestion, boil, command, completeness
- plan-ceo-review（gstack） - 相似 - 共享領域：planning；共享分類：思考框架型、流程型；共同關鍵詞：askuserquestion, boil, completeness, completion

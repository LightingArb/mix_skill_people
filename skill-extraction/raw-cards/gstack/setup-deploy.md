...
### 和其他 skill 的潛在關聯
- land-and-deploy（gstack） - 相似 - 共享領域：shipping；共享分類：工具程序型、流程型；共同關鍵詞：askuserquestion, boil, completeness, completion
- canary（gstack） - 相似 - 共享領域：shipping；共享分類：工具程序型、流程型；共同關鍵詞：askuserquestion, boil, completeness, completion
- document-release（gstack） - 相似 - 共享領域：shipping；共享分類：工具程序型、流程型；共同關鍵詞：all, askuserquestion, boil, completeness
- ship（gstack） - 相似 - 共享領域：shipping；共享分類：工具程序型、流程型；共同關鍵詞：askuserquestion, boil, completeness, completion

...
### 和其他 skill 的潛在關聯
- ship（gstack） - 相似 - 共享領域：review；共享分類：審查型、流程型；共同關鍵詞：asked, askuserquestion, base, boil
- review（gstack） - 相似 - 共享領域：review；共享分類：思考框架型、審查型、流程型；共同關鍵詞：analyzes, asked, askuserquestion, base
- plan-ceo-review（gstack） - 相似 - 共享領域：review；共享分類：思考框架型、審查型、流程型；共同關鍵詞：asked, askuserquestion, base, boil
- land-and-deploy（gstack） - 相似 - 共享領域：review；共享分類：審查型、流程型；共同關鍵詞：arguments, askuserquestion, base, boil

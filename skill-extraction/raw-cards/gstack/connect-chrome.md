...
### 和其他 skill 的潛在關聯
- land-and-deploy（gstack） - 相似 - 共享領域：browser；共享分類：工具程序型、流程型；共同關鍵詞：askuserquestion, boil, browse, building
- qa（gstack） - 相似 - 共享領域：browser；共享分類：工具程序型、流程型；共同關鍵詞：asked, askuserquestion, boil, browse
- office-hours（gstack） - 互補 - 共同關鍵詞：asked, askuserquestion, boil, browse
- qa-only（gstack） - 相似 - 共享領域：browser；共享分類：流程型；共同關鍵詞：asked, askuserquestion, boil, browse

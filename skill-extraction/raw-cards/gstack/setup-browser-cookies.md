...
### 和其他 skill 的潛在關聯
- SKILL（gstack） - 相似 - 共享領域：browser；共享分類：工具程序型；共同關鍵詞：asked, browse, browser, command
- browse（gstack） - 相似 - 共享領域：browser；共享分類：工具程序型；共同關鍵詞：asked, browse, browser, command
- connect-chrome（gstack） - 相似 - 共享領域：browser；共享分類：工具程序型；共同關鍵詞：asked, browse, browser, command
- qa（gstack） - 相似 - 共享領域：browser；共享分類：工具程序型；共同關鍵詞：asked, browse, command, completion

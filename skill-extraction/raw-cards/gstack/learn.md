...
### 和其他 skill 的潛在關聯
- retro（gstack） - 相似 - 共享領域：learning；共享分類：流程型；共同關鍵詞：asked, askuserquestion, boil, completeness
- qa（gstack） - 互補 - 共享分類：工具程序型、流程型；共同關鍵詞：asked, asks, askuserquestion, boil
- ship（gstack） - 互補 - 共享分類：工具程序型、流程型；共同關鍵詞：about, asked, asks, askuserquestion
- office-hours（gstack） - 互補 - 共同關鍵詞：about, asked, askuserquestion, boil

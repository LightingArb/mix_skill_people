...
> Proactively suggest when the user describes a new product idea or is exploring whether something is worth building — before any code is written
...
### 和其他 skill 的潛在關聯
- plan-ceo-review（gstack） - 相似 - 共享領域：planning；共享分類：思考框架型、人格型；共同關鍵詞：asked, askuserquestion, boil, building
- design-consultation（gstack） - 相似 - 共享領域：design, planning；共享分類：思考框架型、人格型；共同關鍵詞：asked, askuserquestion, boil, browse
- plan-eng-review（gstack） - 相似 - 共享領域：planning；共享分類：思考框架型、人格型；共同關鍵詞：about, asked, askuserquestion, boil
- plan-design-review（gstack） - 相似 - 共享領域：design, planning；共享分類：思考框架型、人格型；共同關鍵詞：asked, askuserquestion, boil, building

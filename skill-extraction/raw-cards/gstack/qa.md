...
### 和其他 skill 的潛在關聯
- qa-only（gstack） - 相似 - 共享領域：browser, debugging, review；共享分類：審查型、流程型；共同關鍵詞：additional, application, asked, askuserquestion
- design-review（gstack） - 相似 - 共享領域：review；共享分類：審查型、流程型；共同關鍵詞：additional, after, asked, askuserquestion
- ship（gstack） - 相似 - 共享領域：review, testing；共享分類：審查型、工具程序型、流程型；共同關鍵詞：asked, asks, askuserquestion, base
- plan-ceo-review（gstack） - 相似 - 共享領域：review；共享分類：審查型、流程型；共同關鍵詞：after, asked, askuserquestion, base

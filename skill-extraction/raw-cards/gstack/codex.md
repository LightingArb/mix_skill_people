...
### 和其他 skill 的潛在關聯
- autoplan（gstack） - 相似 - 共享領域：meta, review；共享分類：審查型、流程型；共同關鍵詞：asked, askuserquestion, base, boil
- plan-ceo-review（gstack） - 相似 - 共享領域：review；共享分類：審查型、流程型；共同關鍵詞：ask, asked, askuserquestion, base
- ship（gstack） - 相似 - 共享領域：review；共享分類：審查型、工具程序型、流程型；共同關鍵詞：adversarial, asked, askuserquestion, base
- review（gstack） - 相似 - 共享領域：review；共享分類：審查型、流程型；共同關鍵詞：adversarial, asked, askuserquestion, base

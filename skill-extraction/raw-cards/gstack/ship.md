...
- 常見觸發語句：ship / deploy / push to main / create a PR / merge and push
...
> Use when asked to "ship", "deploy", "push to main", "create a PR", or "merge and push"
...
### 和其他 skill 的潛在關聯
- review（gstack） - 相似 - 共享領域：review, shipping, testing；共享分類：審查型、流程型；共同關鍵詞：about, adversarial, asked, askuserquestion
- plan-eng-review（gstack） - 相似 - 共享領域：review, testing；共享分類：審查型、流程型；共同關鍵詞：about, affected, asked, askuserquestion
- qa（gstack） - 相似 - 共享領域：review, testing；共享分類：審查型、工具程序型、流程型；共同關鍵詞：asked, asks, askuserquestion, base
- land-and-deploy（gstack） - 相似 - 共享領域：review, shipping；共享分類：審查型、工具程序型、流程型；共同關鍵詞：askuserquestion, base, boil, branch

...
- card_kind：skill
- language：en
- canonical_group：gstack::canary/skill.md
...
### 和其他 skill 的潛在關聯
- seo-audit（marketingskills） - 相似 - 共享領域：browser, performance, review；共享分類：審查型、工具程序型；共同關鍵詞：errors, format, page
- lead-magnets（marketingskills） - 相似 - 共享領域：browser, review, shipping；共享分類：審查型、工具程序型、流程型；共同關鍵詞：format, page, plan, what
- figma-use（openai-skills） - 相似 - 共享領域：browser, review, shipping；共享分類：審查型、工具程序型、流程型；共同關鍵詞：failures, first, page, rules
- ui-ux-pro-max（ui-ux-pro-max-skill） - 相似 - 共享領域：browser, review, shipping；共享分類：審查型、工具程序型、流程型；共同關鍵詞：app, page, plan, rules

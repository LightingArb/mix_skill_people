...
- card_kind：skill
- language：en
- canonical_group：gstack::qa/skill.md

### 一句話定位
系統化測試網站後直接修 bug、逐項驗證並提交原子修復的 QA 技能。
...
### 適用場景
- 適合在需要「系統化測試網站後直接修 bug、逐項驗證並提交原子修復的 QA 技能」的工作階段使用。
- 常見觸發語句：qa / QA / test this site / find bugs / test and fix / fix what's broken / does this work?
...
> Proactively suggest when the user says a feature is ready for testing or asks "does this work?"
...
### 和其他 skill 的潛在關聯
- seo-audit（marketingskills） - 相似 - 共享領域：browser, review；共享分類：審查型、工具程序型；共同關鍵詞：building, format, framework, health
- analytics-tracking（marketingskills） - 相似 - 共享領域：debugging, review, testing；共享分類：審查型、工具程序型、流程型；共同關鍵詞：asks, format, framework, output
- schema-markup（marketingskills） - 相似 - 共享領域：browser, review, testing；共享分類：審查型、工具程序型、流程型；共同關鍵詞：fix, format, output, quick
- figma-use（openai-skills） - 相似 - 共享領域：browser, debugging, review；共享分類：審查型、工具程序型、流程型；共同關鍵詞：bugs, context, critical, first

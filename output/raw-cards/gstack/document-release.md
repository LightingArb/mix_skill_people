...
- card_kind：skill
- language：en
- canonical_group：gstack::document-release/skill.md
...
### 和其他 skill 的潛在關聯
- copywriting（marketingskills） - 相似 - 共享領域：meta, shipping；共享分類：工具程序型、流程型；共同關鍵詞：about, format, make, output
- content-strategy（marketingskills） - 相似 - 共享領域：meta, shipping；共享分類：工具程序型、流程型；共同關鍵詞：about, format, output, plan
- lead-magnets（marketingskills） - 相似 - 共享領域：meta, shipping；共享分類：工具程序型、流程型；共同關鍵詞：after, format, output, plan
- product-marketing-context（marketingskills） - 相似 - 共享領域：meta, shipping；共享分類：工具程序型、流程型；共同關鍵詞：all, project, step, update
